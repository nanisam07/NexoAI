...
<div className="mt-6 rounded-3xl border border-blue-500/20 bg-blue-500/10 p-5">
  ...
  <div className="flex items-center gap-2 mb-3">
    ...
    <p className="text-xs uppercase tracking-[0.25em] text-cyan-300 font-bold">
  ...
  <div className="space-y-3 text-sm">
    ...
    <div className="rounded-2xl bg-black/20 border border-white/5 p-3">
      ...
      <p className="text-white font-semibold tracking-[0.3em]">
        789123
      </p>
  ...
  <p className="text-[11px] text-gray-400 mt-4 leading-relaxed">
    ...
    Demo credentials are provided only for internship evaluation and testing purposes.
