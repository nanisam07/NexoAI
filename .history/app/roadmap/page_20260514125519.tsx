...
export default function RoadmapPage() {
  ...
  const roadmapPhases = [
    { title: "Programming Foundations", duration: "2 Weeks", topics: ["HTML & CSS", "JavaScript", "Git & GitHub"] },
    { title: "Frontend Development", duration: "4 Weeks", topics: ["React.js", "Next.js", "Tailwind CSS", "REST APIs"] },
    { title: "Backend Engineering", duration: "4 Weeks", topics: ["Node.js", "Express.js", "MongoDB", "Authentication"] },
    { title: "Real-World Projects", duration: "3 Weeks", topics: ["EdTech Platform", "Dashboard UI", "AI SaaS Clone"] },
    { title: "Interview Preparation", duration: "2 Weeks", topics: ["DSA", "Resume Building", "Mock Interviews"] },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tight leading-[0.9] mb-10">
            Build your <span className="bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/40 text-blue-500">Nexora Journey</span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl font-medium leading-relaxed max-w-2xl mx-auto">
            Our AI engine maps your career goals against industry demand to create a surgical learning path.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-black/40 backdrop-blur-3xl rounded-[3.4rem] p-8 md:p-14">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
              {[
                { label: "Career Goal", options: ["Full Stack Developer", "AI Engineer", "Cyber Security"] },
                { label: "Skill Level", options: ["Beginner", "Intermediate", "Advanced"] },
                { label: "Study Time", options: ["1-2 Hours", "4 Hours", "Full-Time"] },
                { label: "Learning Style", options: ["Project Based", "Theory & Quiz", "Video Intensive"] },
                { label: "Timeline", options: ["3 Months", "6 Months", "Accelerated"] }
              ].map((field) => (
            ...
            <div className="mt-12 flex justify-center">
              <button
                ...
                className="group relative px-12 py-5 rounded-full bg-white text-black font-black text-sm hover:scale-105 active:scale-95 transition-all shadow-[0_0_50px_rgba(255,255,255,0.1)]"
              >
          ...
          {generated && (
            ...
            >
              ...
              <div className="glass-island rounded-[3rem] border border-blue-500/10 bg-blue-500/[0.03] p-12 relative overflow-hidden">
                ...
                <h2 className="text-4xl md:text-6xl font-black text-white tracking-tightest mb-6 leading-none">
                  Job Ready <br /> in <span className="text-blue-500">180 Days.</span>
                </h2>
                <p className="text-gray-400 text-lg max-w-3xl leading-relaxed font-medium">
                  Analysis complete. Based on your B.Tech background and preference for project-based learning, we've optimized your path for <span className="text-white">Fullstack Production Readiness.</span>
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="w-full md:w-[45%] glass-island rounded-[2.5rem] border border-white/5 p-8 md:p-10 hover:border-blue-500/20 transition-all group">
                      <div className="flex justify-between items-start mb-6">
                        <span className="text-[10px] font-black uppercase tracking-widest text-blue-500">Phase 0{index + 1}</span>
                      ...
                      <h3 className="text-3xl font-black text-white mb-6 group-hover:text-blue-400 transition-colors">{phase.title}</h3>
                      
                      <div className="flex flex-wrap gap-2 mb-8">
                        {phase.topics.map(topic => (
                          <span key={topic} className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/5 text-[11px] font-bold text-gray-500">
                            {topic}
                          </span>
                        ))}
                      </div>
