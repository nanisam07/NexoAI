          ...
          <div className="glass-island rounded-[2.5rem] border border-white/5 h-full p-6 flex flex-col justify-between">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 rounded-2xl bg-red-500/20 border border-red-500/20 text-red-400 text-sm font-bold hover:bg-red-500/30 transition"
              >
                Logout
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div
                  className={`absolute -right-10 -bottom-10 w-32 h-32 bg-gradient-to-br ${stat.color} opacity-5 blur-3xl group-hover:opacity-20 transition-opacity`}
                />
                ...
                {[
                  {
                    ...
                    progress: 75,
                    img:
                      "https://images.unsplash.com/photo-1618477388954-7852f32655ec?auto=format&fit=crop&q=80&w=200",
                  },
                  {
                    name:
                      "AI Cyber Security",
            ...
            <div className="glass-island rounded-[2.5rem] border border-blue-500/20 bg-blue-500/5 p-8 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                  ...
                  Based on your Cyber Security progress,
                  start the Network Threat Detection module next.
